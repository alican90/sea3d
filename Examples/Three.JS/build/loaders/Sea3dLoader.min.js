...
SEA3D.Geometry=function(a,b,c){var d,e;this.name=a;this.data=b;this.sea=c;SEA3D.GeometryBase(this);if(this.attrib&4)for(this.normal=[],a=0;a<this.length;)this.normal[a++]=b.readFloat();if(this.attrib&8)for(this.tangent=[],a=0;a<this.length;)tangent[a++]=b.readFloat();if(this.attrib&32)for(this.uv=[],this.uv.length=b.readUByte(),e=2*this.numVertex,a=0;a<this.uv.length;)for(this.uv[a++]=d=[],c=0;c<e;)d[c++]=b.readFloat();if(this.attrib&64){this.jointPerVertex=b.readUByte();c=this.numVertex*this.jointPerVertex;
this.joint=[];this.weight=[];for(a=0;a<c;)this.joint[a++]=b.readUShort();for(a=0;a<c;)this.weight[a++]=b.readFloat()}if(this.attrib&128)for(a=b.readUByte(),d=((a&64)>>6|(a&128)>>6)+1,e=4*numVertex,this.color=[],this.color.length=a&15,a=0;a<color.length;a++){var f=[];switch(d){case 1:for(c=0;c<e;)f[c++]=b.readUnsignedByte()/255,f[c++]=0,f[c++]=0,f[c++]=1;break;case 2:for(c=0;c<e;)f[c++]=b.readUnsignedByte()/255,f[c++]=b.readUnsignedByte()/255,f[c++]=0,f[c++]=1;break;case 3:for(c=0;c<e;)f[c++]=b.readUnsignedByte()/
...
[];for(a=0;a<this.length;)this.vertex[a++]=e()/f*d;this.indexes=[];this.indexes.length=b.readUByte();if(this.attrib&2)for(a=0;a<this.indexes.length;a++)for(f=b.readUInteger(),this.indexes[a]=e=[],c=0;c<f;c++){d=b.readUInteger();var g=b.readUInteger(),h=b.readUInteger(),k=b.readUInteger();e.push(d);e.push(g);e.push(h);0<k&&(e.push(h),e.push(k+1),e.push(d))}else for(f=3*b.readUInteger(),a=0;a<this.indexes.length;a++)for(this.indexes[a]=e=[],c=0;c<f;)e[c++]=b.readUInteger()};
...
SEA3D.Morph=function(a,b,c){this.name=a;this.data=b;this.sea=c;SEA3D.GeometryBase(this);c=0!=(this.attrib&2);var d=0!=(this.attrib&4),e=3*this.numVertex,f=b.readUShort();this.node=[];for(var g=0;g<f;g++){a=b.readUTF8();if(c){var h=[];for(j=0;j<e;)h[j++]=b.readFloat()}if(d){var k=[];for(j=0;j<e;)k[j++]=b.readFloat()}this.node[g]={vertex:h,normal:k,name:a}}};SEA3D.Morph.prototype.type="mph";
...
c));this.depthMask=0==(this.attrib&256);a=b.readUByte();for(i=0;i<a;++i){var d=b.readUShort(),e=b.readUShort(),f=b.position,g;switch(d){case SEA3D.Material.DEFAULT:g={ambientColor:b.readUInt24(),diffuseColor:b.readUInt24(),specularColor:b.readUInt24(),specular:b.readFloat(),gloss:b.readFloat()};break;case SEA3D.Material.COMPOSITE_TEXTURE:g={composite:c.getObject(b.readUInt())};break;case SEA3D.Material.DIFFUSE_MAP:g={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.SPECULAR_MAP:g={texture:c.getObject(b.readUInt())};
break;case SEA3D.Material.NORMAL_MAP:g={texture:c.getObject(b.readUInt())};break;case SEA3D.Material.REFLECTION:case SEA3D.Material.FRESNEL_REFLECTION:g={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};d==SEA3D.Material.FRESNEL_REFLECTION&&(g.power=b.readFloat(),g.normal=b.readFloat());break;case SEA3D.Material.REFRACTION:g={texture:c.getObject(b.readUInt()),alpha:b.readFloat(),ior:b.readFloat()};break;case SEA3D.Material.RIM:g={color:b.readUInt24(),strength:b.readFloat(),power:b.readFloat(),
blendMode:b.readBlendMode()};break;case SEA3D.Material.LIGHT_MAP:g={texture:c.getObject(b.readUInt()),channel:b.readUByte(),blendMode:b.readBlendMode()};break;case SEA3D.Material.DETAIL_MAP:g={texture:c.getObject(b.readUInt()),scale:b.readFloat(),blendMode:b.readBlendMode()};break;case SEA3D.Material.CEL:g={color:b.readUInt24(),levels:b.readUByte(),size:b.readFloat(),specularCutOff:b.readFloat(),smoothness:b.readFloat()};break;case SEA3D.Material.TRANSLUCENT:g={color:b.readUInt24(),translucency:b.readFloat(),
scattering:b.readFloat()};break;case SEA3D.Material.BLEND_NORMAL_MAP:methodAttrib=b.readUByte();g={texture:c.getObject(b.readUInt()),secondaryTexture:c.getObject(b.readUInt())};methodAttrib&1?(g.offsetX0=b.readFloat(),g.offsetY0=b.readFloat(),g.offsetX1=b.readFloat(),g.offsetY1=b.readFloat()):g.offsetX0=g.offsetY0=g.offsetX1=g.offsetY1=0;g.animate=methodAttrib&2;break;case SEA3D.Material.MIRROR_REFLECTION:g={texture:c.getObject(b.readUInt()),alpha:b.readFloat()};break;default:console.warn("MaterialTechnique not found:",
d.toString(16));b.position=f+e;continue}g.kind=d;this.technique.push(g);b.position=f+e}};SEA3D.Material.DEFAULT=0;SEA3D.Material.COMPOSITE_TEXTURE=1;SEA3D.Material.DIFFUSE_MAP=2;SEA3D.Material.SPECULAR_MAP=3;SEA3D.Material.REFLECTION=4;SEA3D.Material.REFRACTION=5;SEA3D.Material.NORMAL_MAP=6;SEA3D.Material.FRESNEL_REFLECTION=7;SEA3D.Material.RIM=8;SEA3D.Material.LIGHT_MAP=9;SEA3D.Material.DETAIL_MAP=10;SEA3D.Material.CEL=11;SEA3D.Material.TRANSLUCENT=12;SEA3D.Material.BLEND_NORMAL_MAP=13;
...
this.currentAnimation.weight),THREE.AnimationHandler.addCrossfade(this,b)):this.currentAnimation.play(void 0!==c?c:this.currentAnimation.currentTime,1)};
THREE.SkinnedMesh.prototype.addAnimations=function(a){this.animations=[];var b=a[0].name.indexOf("/")+1;this.animationNamespace=a[0].name.substring(0,b);for(var c=0;c<a.length;c++){THREE.AnimationHandler.add(a[c]);var d=a[c].name,e=d.substring(b);this.animations[c]=new THREE.Animation(this,d);this.animations[c].loop=a[c].repeat;this.animations[c].name=e;this.animations[e]=this.animations[c]}};THREE.SkinnedMesh.prototype.DISPOSE=THREE.SkinnedMesh.prototype.dispose;
THREE.SkinnedMesh.prototype.dispose=function(){this.stop();this.animations=null;this.DISPOSE()};THREE.SkinnedMesh.prototype.CLONE=THREE.SkinnedMesh.prototype.clone;THREE.SkinnedMesh.prototype.clone=function(a){a=THREE.SkinnedMesh.prototype.CLONE.call(this,a);a.animations=[];for(var b=0;b<this.animations.length;b++)a.animations[b]=new THREE.Animation(a,this.animations[b].data.name),a.animations[b].loop=this.animations[b].loop,a.animations[b].name=this.animations[b].name;return a};
...
THREE.SEA3D.prototype.setShadowMap=function(a,b){a.shadowMapWidth=a.shadowMapHeight=2048;a.castShadow=!0;a.shadowDarkness=void 0!==b?b:1};THREE.SEA3D.prototype.tangent=!0;THREE.SEA3D.prototype.bounding=!0;THREE.SEA3D.prototype.autoPlay=!0;THREE.SEA3D.prototype.matrixAutoUpdate=!0;THREE.SEA3D.prototype.parser=THREE.SEA3D.AUTO;THREE.SEA3D.prototype.getMesh=function(a){return this.objects["m3d/"+a]};THREE.SEA3D.prototype.getDummy=function(a){return this.objects["dmy/"+a]};
THREE.SEA3D.prototype.getLine=function(a){return this.objects["line/"+a]};THREE.SEA3D.prototype.getSound3D=function(a){return this.objects["sn3d/"+a]};THREE.SEA3D.prototype.getMaterial=function(a){return this.objects["mat/"+a]};THREE.SEA3D.prototype.getLight=function(a){return this.objects["lht/"+a]};THREE.SEA3D.prototype.getCamera=function(a){return this.objects["cam/"+a]};THREE.SEA3D.prototype.getTexture=function(a){return this.objects["tex/"+a]};
THREE.SEA3D.prototype.getCubeMap=function(a){return this.objects["cmap/"+a]};THREE.SEA3D.prototype.getJointObject=function(a){return this.objects["jnt/"+a]};THREE.SEA3D.prototype.getSound3D=function(a){return this.objects["sn3d/"+a]};THREE.SEA3D.prototype.getSprite=function(a){return this.objects["m2d/"+a]};THREE.SEA3D.prototype.isPowerOfTwo=function(a){return a?(a&-a)==a:!1};THREE.SEA3D.prototype.nearestPowerOfTwo=function(a){return Math.pow(2,Math.round(Math.log(a)/Math.LN2))};
THREE.SEA3D.prototype.vectorToVector3=function(a){for(var b=[],c=0,d=0;c<a.length;)b[d++]=new THREE.Vector3(a[c++],a[c++],a[c++]);return b};THREE.SEA3D.prototype.vectorToUV=function(a){for(var b=[],c=0;c<a.length;c++)for(var d=b[c]=[],e=a[c],f=0,g=0;f<e.length;f+=2)d[g++]=new THREE.Vector2(e[f],e[f+1]);return b};THREE.SEA3D.prototype.toVector3=function(a){return new THREE.Vector3(a.x,a.y,a.z)};THREE.SEA3D.prototype.scaleColor=function(a,b){return(a>>16)*b<<16|(a>>8&255)*b<<8|(a&255)*b};
...
THREE.SEA3D.prototype.readGeometryBuffer=function(a){var b=a.indexes[0],c=b.length,d=new THREE.BufferGeometry,e,f,g,h;d.attributes={index:{itemSize:1,array:e=new Uint16Array(c)},position:{itemSize:3,array:f=new Float32Array(3*c)},uv:{itemSize:2,array:h=new Float32Array(2*c)}};var k,l,p,q=a.vertex,r=a.normal,t=a.uv?a.uv[0]:void 0;r&&(d.attributes.normal={itemSize:3,array:g=new Float32Array(3*c)});for(var m=0,n=0,s=0;m<c;m+=3,n+=9,s+=6)k=3*b[m],l=3*b[m+2],p=3*b[m+1],f[n]=q[k],f[n+1]=q[k+1],f[n+2]=q[k+
2],f[n+3]=q[l],f[n+4]=q[l+1],f[n+5]=q[l+2],f[n+6]=q[p],f[n+7]=q[p+1],f[n+8]=q[p+2],r&&(g[n]=r[k],g[n+1]=r[k+1],g[n+2]=r[k+2],g[n+3]=r[l],g[n+4]=r[l+1],g[n+5]=r[l+2],g[n+6]=r[p],g[n+7]=r[p+1],g[n+8]=r[p+2]),t?(k=2*b[m],l=2*b[m+2],p=2*b[m+1],h[s]=t[k],h[s+1]=t[k+1],h[s+2]=t[l],h[s+3]=t[l+1],h[s+4]=t[p],h[s+5]=t[p+1]):(h[s]=0,h[s+1]=0,h[s+2]=0,h[s+3]=1,h[s+4]=1,h[s+5]=1),e[m]=m,e[m+1]=m+1,e[m+2]=m+2;r||d.computeVertexNormals();this.tangent&&!a.tangent&&d.computeTangents();this.bounding&&(d.computeBoundingBox(),
d.computeBoundingSphere());d.name=a.name;a.tag=d};
THREE.SEA3D.prototype.readGeometry=function(a){var b,c,d,e=new THREE.Geometry,f,g;e.vertices=this.vectorToVector3(a.vertex);a.normal&&(f=this.vectorToVector3(a.normal));if(a.uv)for(g=this.vectorToUV(a.uv),d=0;d<g.length;d++)e.faceVertexUvs[d]=[];for(b=0;b<a.indexes.length;b++){var h=a.indexes[b],k=h.length/3;for(c=0;c<k;c++){d=3*c;var l,p,q;l=h[d];q=h[d+1];p=h[d+2];d=new THREE.Face3(l,p,q,f?[f[l],f[p],f[q]]:void 0);d.materialIndex=b;e.faces.push(d);if(g)for(d=0;d<g.length;d++)e.faceVertexUvs[d].push([g[d][l],
g[d][p],g[d][q]]);else geometry.faceVertexUvs[0].push([new THREE.UV(0,0),new THREE.UV(0,1),new THREE.UV(1,1)])}}if(a.joint)if(f=[0,0,0,0],g=[0,0,0,0],h=a.jointPerVertex,4<h)for(console.warn("WebGLRenderer: Joint Per Vertex can not be greater than 4 (currently "+a.jointPerVertex+"). Using compression for joints."),d=0;d<a.joint.length;d+=h){k=[0];for(c=1;c<h;c++)l=a.weight[d+c],l>a.weight[d+k[0]]?k.unshift(c):k.push(c);l=(1-(a.weight[d+k[0]]+a.weight[d+k[1]]+a.weight[d+k[2]]+a.weight[d+k[3]]))/4;for(c=
...
THREE.SEA3D.prototype.readMesh2D=function(a){var b;a.material&&(a.material.tag.sprite?b=a.material.tag.sprite:(b=a.material.tag.sprite=new THREE.SpriteMaterial,b.map=a.material.tag.map,b.map.flipY=!0,b.color=a.material.tag.emissive,b.opacity=a.material.tag.opacity,b.blending=a.material.tag.blending));b=new THREE.Sprite(b);b.name=a.name;b.scale.set(a.width,a.height,1);b.position.set(a.position.x,a.position.y,this.invertZ&&!a.parent?-a.position.z:a.position.z);this.sprites=this.sprites||[];this.sprites.push(this.objects["m2d/"+
a.name]=a.tag=b);this.addSceneObject(a)};
...
THREE.SEA3D.prototype.materialTechnique=function(){var a={};a[SEA3D.Material.DEFAULT]=function(a,c){c.ambient.setHex(a.ambientColor);c.emissive.setHex(a.ambientColor);c.color.setHex(a.diffuseColor);c.specular.setHex(this.scaleColor(a.specularColor,a.specular));c.shininess=a.gloss};a[SEA3D.Material.DIFFUSE_MAP]=function(a,c){c.map=a.texture.tag;c.transparent=a.texture.transparent};a[SEA3D.Material.SPECULAR_MAP]=function(a,c){c.specularMap=a.texture.tag};a[SEA3D.Material.NORMAL_MAP]=function(a,c){c.normalMap=
...
THREE.SEA3D.prototype.onError=function(){args.file=this.scope;args.type=THREE.SEA3D.Event.ERROR;args.file.dispatchEvent(args)};THREE.SEA3D.prototype.load=function(a){this.loadBytes();this.file.load(a)};
...
this.readImage;this.file.typeRead[SEA3D.GIF.prototype.type]=this.readImage;this.file.typeRead[SEA3D.MP3.prototype.type]=this.readSound;a&&this.file.read()};SEA3D.Animator=function(a,b){this.mesh=a;this.name=b;this.current="";this.animations={};this.weightSchedule=[];this.warpSchedule=[]};
...
geo:d.geometry,anim:e,loop:g,morph:f}}b.endFunction()},getMorphs:function(a){for(var b=[],c=this.models.length;c--;)this.models[c].name===a&&(b=this.models[c].morph);return b},getAnimations:function(a){for(var b=[],c=this.models.length;c--;)this.models[c].name===a&&(b[0]=this.models[c].anim,b[1]=this.models[c].loop);return b},getGeometry:function(a,b,c,d){for(var e,f=0,g=this.models.length;f<g;f++)this.models[f].name===a&&(e=this.models[f].geo);b&&(void 0==e.vertices?this.scaleBufferGeometry(e,c,
d):this.scaleGeometry(e,c,d));return e},scaleGeometry:function(a,b,c){b=b||1;c=c||"z";for(var d=0;d<a.vertices.length;d++){var e=a.vertices[d];e.x="x"===c?e.x*-b:e.x*b;e.y="y"===c?e.y*-b:e.y*b;e.z="z"===c?e.z*-b:e.z*b}a.computeFaceNormals();a.computeVertexNormals();a.verticesNeedUpdate=!0},scaleBufferGeometry:function(a,b,c){b=b||1;c=c||"z";for(var d=a.attributes.position,e=d.array,f=0;f<e.length;f++)e[f+0]="x"===c?e[f+0]*-b:e[f+0]*b,e[f+1]="y"===c?e[f+1]*-b:e[f+1]*b,e[f+2]="z"===c?e[f+2]*-b:e[f+
2]*b;a.computeVertexNormals();a.verticesNeedUpdate=!0;d.needsUpdate=!0}};
